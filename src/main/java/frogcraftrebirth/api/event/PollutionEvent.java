...
/**
 * PollutionEvent will be fired when a machine produce pollution and affect the
 * environment nearby. You can use <code>source</code> reference to access the
 * tile entity involved.
 * <p>
