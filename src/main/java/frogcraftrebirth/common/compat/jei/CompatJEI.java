...
public class CompatJEI implements IModPlugin, ICompatModuleFrog {
	...
	public void register(IModRegistry registry) {
		...
		registry.addRecipeCategoryCraftingItem(new ItemStack(FrogBlocks.MACHINE, 1, 0), "frogcraftrebirth.chemreaction");
		registry.addRecipeCategoryCraftingItem(new ItemStack(FrogBlocks.CONDENSE_TOWER, 1, 0), "frogcraftrebirth.condensation");
		registry.addRecipeCategoryCraftingItem(new ItemStack(FrogBlocks.MACHINE, 1, 2), "frogcraftrebirth.pyrolyzation");
		...
		registry.addDescription(new ItemStack(FrogBlocks.MACHINE, 1, 0), "jei.doc.advChemReactor");
		registry.addDescription(new ItemStack(FrogBlocks.MACHINE, 1, 1), "jei.doc.airPump");
		registry.addDescription(new ItemStack(FrogBlocks.MACHINE, 1, 2), "jei.doc.pyrolyzer");
		registry.addDescription(new ItemStack(FrogBlocks.MACHINE, 1, 3), "jei.doc.liquefier");
		
		registry.addDescription(Arrays.asList(new ItemStack(FrogBlocks.CONDENSE_TOWER, 1, 0), new ItemStack(FrogBlocks.CONDENSE_TOWER, 1, 1), new ItemStack(FrogBlocks.CONDENSE_TOWER, 1, 2)), "jei.doc.condenseTower");
	}
