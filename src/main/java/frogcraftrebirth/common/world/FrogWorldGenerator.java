...
public class FrogWorldGenerator implements IWorldGenerator{
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider) {
		...
		new WorldGenClayFake(FrogBlocks.frogOres, 0, 5).generate(world, random, xCor, world.getTopSolidOrLiquidBlock(xCor, zCor), zCor);
		new WorldGenMinable(FrogBlocks.frogOres, 1, 15, Blocks.stone).generate(world, random, xCor, world.getTopSolidOrLiquidBlock(xCor, zCor), zCor);
